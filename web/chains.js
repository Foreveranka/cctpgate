 ...
 * knows how to finish it, and today that is Avalanche and Stellar.
 *
...
export const CHAINS = {
  avalanche: {
    ...
    family: 'evm',
    live: true,
    /// The source chain. Standard attestation completes in seconds here, which
    /// is why the C-Chain is the fastest place in the protocol to start from.
    /// Arriving on it, a user lands with USDC and no AVAX to move it with.
    arrivesReady: false,
  },
  stellar: {
    name: 'Stellar',
  ...
  base: { name: 'Base', domain: 6, family: 'evm', live: false },
